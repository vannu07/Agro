...
This file provides Advanced AI integration. For the complete methodology, see PROJECT_RULES.md.
...
## AI-Engine Specific Tips

For AI-specific enhancements, see project documentation.

Key recommendations:
- High performance for quick iterations and simple edits
- Accurate models for complex planning and analysis
