...
> **Comprehensive reference.** Core rules auto-load from `.ai_config/AI_RULES.md`. This document provides deep explanations and examples for when you need the full picture.
